      ...
      <section className="col-span-12 xl:col-span-5 terminal-page-frame group p-6 md:p-8 transition-all duration-500 hover:border-primary/30 hover-lift-premium">
        ...
        <div className="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">Solana Alert Center</h2>
              <p className="text-sm text-muted-foreground/80">Create automatic alerts for Solana token price movement or score changes.</p>
            </div>
          </div>
          <button
            onClick={fetchAlerts}
