    ...
    <div className="container max-w-7xl px-4 py-8 md:px-6 md:py-12">
      ...
      <div className="relative rounded-2xl border border-border/30 bg-card/60 backdrop-blur-xl p-8 md:p-12 overflow-hidden mb-10">
        ...
        <div className="relative z-10 flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Solana Token Scanner Documentation</h1>
            <p className="mt-1 text-sm text-muted-foreground/70">Learn how TokenSight AI scans Solana tokens, calculates risk, and helps traders evaluate entries with on-chain data.</p>
          </div>
        </div>
      </div>
